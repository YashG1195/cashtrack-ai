...
import { Sparkles, Mail, Lock, Loader2, Eye, EyeOff, CheckCircle2, ChevronRight } from "lucide-react";
  ...
  return (
    <div className="min-h-screen flex flex-col lg:flex-row bg-[#050816] text-white font-sans selection:bg-[#FBBF24]/30">
      ...
      <div className="hidden lg:flex lg:w-[55%] relative overflow-hidden flex-col justify-between p-16">
        ...
        <div className="relative z-10 max-w-xl mt-12 mb-auto">
          ...
          <p className="text-[#94A3B8] text-lg leading-relaxed mb-10">
            Track expenses, manage budgets, achieve goals, and get AI-powered financial insights in one premium unified platform.
          </p>
      ...
      <div className="flex-1 flex flex-col justify-center items-center p-6 lg:p-16 relative z-10">
        ...
        {/* Mobile Logo */}
        <Link href="/" className="lg:hidden flex items-center gap-3 font-bold text-2xl tracking-tight mb-12">
        ...
        {/* Auth Card */}
        <div className="w-full max-w-[480px] bg-[rgba(17,24,39,0.75)] backdrop-blur-xl border border-white/10 rounded-[24px] p-8 sm:p-10 shadow-2xl shadow-black/50">
          ...
          {success && (
            <div className="mb-6 p-4 rounded-xl bg-emerald-500/10 border border-emerald-500/20 flex items-center gap-3 animate-in fade-in zoom-in duration-300">
              ...
              <p className="text-sm text-emerald-400 font-medium">Logged in successfully! Redirecting...</p>
            </div>
          )}
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="flex items-center justify-between pt-1">
              <Link href="/forgot-password" className="text-sm font-medium text-[#FBBF24] hover:text-[#9353d3] transition-colors ml-auto">
                Forgot password?
              </Link>
            </div>
          ...
          <p className="mt-8 text-center text-sm text-[#94A3B8]">
            ...
            <Link href="/signup" className="text-white font-semibold hover:text-[#FBBF24] transition-colors">
              Sign up
            </Link>
          </p>
